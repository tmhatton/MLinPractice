...
echo "  training set"
python -m code.feature_extraction.extract_features data/preprocessing/split/training.csv data/feature_extraction/training.pickle -e data/feature_extraction/pipeline.pickle --char_length --token_length --hashtag_num --mention_num --url_num --cap_letter --punc_num --photos_num --videos_num --weekday --sentiment --times_of_day
